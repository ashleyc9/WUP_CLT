...
The standard deviation is with n = 9, `r not `. The expected value is. The mean will always stay the same and the standard deviation will always shrink. This numb is a demonstration of what happens. 
