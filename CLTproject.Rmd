...
Take the standard deviation and put it in the data that is from the central limit. The standard deviation shrinks as the number gets higher example 4 is divided by 2, 9 is divided by 3. 16 divided by 4 and so on.
The standard deviation is with n = 9. The expected value is 41. The mean will always stay the same and the standard deviation will always shrink. This numb is a demonstration of what happens. 
`r sd (my1000$k3)`
...
the standard deviation is now a quarter of what it was before which now it is 10. The standard deviation continues to shrink with this numb value. 
we expect 10 and we got `r sd(my1000$k4)`
...
we expect 8 and we got `r sd(my1000$k5)`
What I expected was a little off from what the code gave us for the expected value. The standard deviation continues to dhrink with this numb value as well. 
...
we expect 6 and we got `r sd(my1000$k6)` 
My expected value was off by a little, it rounds up to 7 with the code. 
